...
def get_bca_logo_html(width=220, height=62):
    return f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 85" width="{width}" height="{height}" style="vertical-align: middle;">
    <defs>
        <linearGradient id="bcaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stop-color="#001F3F"/>
            <stop offset="50%" stop-color="#00529C"/>
    ...
    <rect width="320" height="85" rx="14" fill="url(#bcaGrad)" filter="url(#glow)"/>
    <rect x="2" y="2" width="316" height="81" rx="12" fill="none" stroke="url(#goldGrad)" stroke-width="1.5" stroke-opacity="0.7"/>
    <g transform="translate(18, 14)">
        <rect width="56" height="57" rx="12" fill="#FFFFFF"/>
        <path d="M 28,10 L 46,28 L 28,46 L 10,28 Z" fill="#00529C"/>
        <path d="M 28,18 L 38,28 L 28,38 L 18,28 Z" fill="#FFFFFF"/>
        <circle cx="28" cy="28" r="5" fill="#002B49"/>
    </g>
    <text x="88" y="48" font-family="'Plus Jakarta Sans', Arial, sans-serif" font-weight="900" font-size="34" fill="#FFFFFF" letter-spacing="2">BCA</text>
    <text x="89" y="66" font-family="'Plus Jakarta Sans', Arial, sans-serif" font-weight="700" font-size="10" fill="#F59E0B" letter-spacing="1.5">BANK CENTRAL ASIA</text>
</svg>'''
...
# ---------------------------------------------------------
st.set_page_config(
    page_title="BCA ATM Reconciliation & Executive Cash Variance System",
    page_icon="🏦",
    layout="wide",
...
<div style="text-align: center; padding: 14px 10px 18px 10px; background: #FFFFFF; border-radius: 14px; border: 1px solid #E2E8F0; margin-bottom: 22px; box-shadow: 0 6px 16px -2px rgba(0, 43, 73, 0.08);">
    {get_bca_logo_html(width=205, height=58)}
    <div style="margin-top: 10px; font-size: 13px; font-weight: 800; color: #002B49; letter-spacing: -0.2px;">SISTEM REKONSILIASI KAS</div>
    <div style="font-size: 10px; color: #64748B; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; margin-top: 2px;">Operational Audit Portal</div>
</div>
""", unsafe_allow_html=True)
