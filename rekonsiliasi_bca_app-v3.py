...
# ---------------------------------------------------------
    ...
    # Display Dataframe with high precision styling (compatible with all Pandas versions)
    ...
    def highlight_negative(v):
        return 'color: red; font-weight: bold;' if isinstance(v, (int, float)) and v < 0 else ''
